...
struct slsi_hip_stats {
	struct slsi_hip_fh_stats tx_stats[SLSI_HIP_FH_BUF_MAX];
	u8                       tx_buf_i;
	u32                      tx_sched;
	...
	/* TODO_HARDMAC_HIP3 */
	u32                      tx_q_pause[SLSI_PS_MAX_TID_PRI];
	u32                      tx_q_resume[SLSI_PS_MAX_TID_PRI];
	u32                      sdio_cmd53_errors[9];
